...
*/
	...
	return array(
		...
		'u_approved_body' => "Profilinizi buradan görebilirsiniz:\n\n^url\n\nTeşekkür ederiz,\n\n^site_title",
		'u_approved_subject' => '^site_title hesabınız onaylandı',

		'wall_post_body' => "^f_handle ^site_title duvarınıza birşeyler yazdı:\n\n^open^post^close\n\nGönderiyi buradan cevaplayabilirsiniz:\n\n^url\n\nTeşekkür ederiz,\n\n^site_title",
		'wall_post_subject' => 'Birisi ^site_title duvarınıza yazdı.',

		'welcome_body' => "^site_title\'a kayıt olduğunuz için teşekkür ederiz.\n\n^custom^confirmKayıt detaylarınız aşağıdaki gibidir:\n\nKullanıcı adınız: ^handle\nE-posta adresiniz: ^email\n\nİleride kullanmak için bu e-postayı lütfen saklayınız.\n\nTeşekkür ederiz,\n\n^site_title\n^url",
		'welcome_confirm' => "E-posta hesabınızı doğrulamak için lütfen aşağıdaki bağlantıya tıklayınız.\n\n^url\n\n",
		'welcome_subject' => '^site_title\'a hoşgeldiniz !',
	);
